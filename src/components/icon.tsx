...
export function Icon({name, shape, stroke = 0.9, color = "currentColor", size, customClass}: IconProps): JSX.Element {
    ...
    switch(name) {
        ...
        case 'heroicons:globe-asia-australia':
            return iconContainer(
        ...
        case 'heroicons:chat-bubble-left-right':
            return iconContainer(
